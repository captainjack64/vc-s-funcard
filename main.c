...
/* Standard responses */
/* Videocrypt 1 ATR   */
const uint8_t _atr_vc1[] PROGMEM = {
	0x3f, 0xfa, 0x11, 0x25, 0x05, 0x00, 0x01, 0xb0, 
	0x02, 0x3b, 0x36, 0x4d, 0x59, 0x02, 0x80, 0x81
};
/* Videocrypt S ATR ?? */
const uint8_t _atr_vcs[] PROGMEM = {
	0x3f, 0xfa, 0x12, 0x25, 0x05, 0x00, 0x01, 0xb0,
	0x02, 0x3b, 0x36, 0x4d, 0x59, 0x02, 0x80, 0x81
};

const uint8_t _atr_vc2[] PROGMEM = { 
	0x3f, 0x7e, 0x13, 0x25, 0x03, 0x21, 0xb0, 0x12,
	0x00, 0x00, 0x4d, 0x59, 0x00, 0x02, 0x00, 0x46,
	0x4e, 0x01, 0x00
};

const uint8_t  _serial[] PROGMEM = {
	0x70, 0x2b, 0x02, 0x56, 0x02, 0x03, 0x04
};

const uint8_t  _ans_7c[] PROGMEM = {
	0x7C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

const uint8_t  _ans_78[] PROGMEM = {
	0x78, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
};

const uint8_t  _ans_7a[] PROGMEM = { 
	0x7A, 0x80, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
	0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
	0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20
};
const uint8_t _ack[] PROGMEM = {
	0x90, 0x00 
};
